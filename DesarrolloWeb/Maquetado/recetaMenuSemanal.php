...
if (isset($_GET["operacion"])){
    ...
    header('Location: '.'recetaMenuSemanal.php?idReceta='.(int)$_GET["idReceta"]);
...
<div class="container contenedorBotones">
    ...
    <?php } ?>
    <div class="row">
        <button class="btn  boton" type="submit" id="botonGuardar" onclick="agregarGuardado(<?php echo $_GET['idReceta']?>)">
            Guardar
        </button>
    </div>
</div>
<script>
    $(document).ready(function (){
        ...
        if($recetaGuardada){?>
            $("#botonGuardar").html("No guardar");
            $("#botonGuardar").attr("onclick","eliminarGuardados(<?php echo $_GET['idReceta']?>)");
        <?php } ?>
        });
