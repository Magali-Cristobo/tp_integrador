...
$json_datosReceta = getUrl(API_URL . $_GET["idReceta"]);
...
<div class="container contenedorBotones">
    <button class="btn  boton" id="botonAniadirAlMenu" type="submit" data-toggle="modal" data-target="#modalAniadirAlMenu">Añadir
        al menu
    </button>
    <button class="btn  boton" type="submit" id="botonEliminarReceta" onclick="eliminarReceta(<?php echo $_GET['idReceta']?>)">Eliminar receta</button>
