...
if (isset($_GET["operacion"])){
    ...
    header('Location: '.'recetaMisGuardados.php?idReceta='.(int)$_GET["idReceta"]);
}
...
<div class="container contenedorBotones">
    ...
    <?php } ?>
    <div class="row">
        <button class="btn  boton" type="submit" id="botonAniadirAlMenu" data-toggle="modal" data-target="#modalAniadirAlMenu">Añadir al menu</button>
        <button class="btn  boton" type="submit" id="botonNoGuardar" onclick="eliminarGuardados(<?php echo $_GET['idReceta']?>)">No guardar</button>
    </div>
</div>
