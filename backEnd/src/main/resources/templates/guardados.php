...
<head>
    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css"><link rel="stylesheet" href="estiloListas.css">
    ...
    <form class="form-inline" style="width: 90%">
        ...
        <div class="navbar-collapse collapse" id="navbarNav">
            <ul class="navbar-nav flex-row ml-auto justify-content-between" style="display: block">
                ...
                <li class="nav-item"><a href="explorar.php" class="nav-link">Explorar</a></li>
...
<br>
<br>
<h4 class="misListas">> Mis recetas guardadas
</h4>
<br>
<div class="container">
    <div class="row">
        <div class="col-4">
            ...
            <a href="home.php">
                <button class="btn btn-block botonExplorar" type="button"
                        style="background-image: url('PlatosComida/arrozConPollo.jpg');"><a href='recetaMisGuardados.php' class='nav-link'></a></button>
            </a>
            <span class="tituloReceta">Pollo con arroz</span>
        </div>
        <div class="col-4">
            <button class="btn btn-block botonExplorar" type="button"
                    style="background-image: url('PlatosComida/canelones.jpg');"><a href='recetaMisGuardados.php' class='nav-link'></a></button>
            <span class="tituloReceta">Canelones</span>
        </div>
        <div class="col-4">
            <button class="btn btn-lg botonExplorar" type="button"><a href='recetaMisGuardados.php' class='nav-link'></a></button>
    ...
    <div class="row">
        <div class="col-4">
            <button class="btn btn-block botonExplorar"><a href='recetaMisGuardados.php' class='nav-link'></a></button>
            <span class="tituloReceta">Milanesa Napolitana</span>
        </div>
        <div class="col-4">
            <button class="btn btn-block botonExplorar" type="button"><a href='recetaMisGuardados.php' class='nav-link'></a></button>
