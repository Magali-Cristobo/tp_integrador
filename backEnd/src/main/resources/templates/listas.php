...
<script>
    $(document).ready(function () {
        $('#aniadirListas').click(function () {
            ...
            $('.row').append("<div class='col-4'><button class='btn  btn-block boton' type='submit' id='hola' data-toggle='modal' data-target='#exampleModal'><a href='listaExpandida.php' class='nav-link'></a>Prueba</button></div>");
            $('.row').append(aniadir);
        });
