...
<button class="btn  btn-block " type="submit" id="aniadirAlMenu" data-toggle="modal" data-target="#exampleModal"><i
        class="fas fa-pencil-alt lapizEditar"></i></button>
...
<button class="btn  boton" id="botonAniadirAlMenu" type="submit" data-toggle="modal" data-target="#exampleModal">Añadir
    al menu
</button>
