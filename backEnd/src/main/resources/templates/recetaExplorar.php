    ...
    <div class="row">
        ...
        <div class="col-7 ">
            <div class="masInformacion">
                <h5 class="informacionExtra">Dificultad: <img class="gorroChef" src="Imagenes/Gorro%20de%20chef.png">
            ...
            <h5 class="informacionExtra">Personas: <img class="personas" src="../img/Imagenes/Logo%20persona.png"> <img
            ...
            <h5 class="informacionExtra">Puntaje: <img class="personas" src="../img/Imagenes/Limon.png"> <img class="personas"
...
<div class="container">
    <div class="row">
        ...
        <button class="btn  boton" type="submit" id="botonGuardar" data-toggle="modal" data-target="#exampleModal">
            Guardar
        </button>
    </div>
</div>
